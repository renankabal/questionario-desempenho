<html>
	...
	<head>
		...
		<body>
			...
			<form action="../perguntas_sql.php" method="POST" name="pergunta7">
			<!-- INICIO DA TABELA DE CONTEÚDO -->
                <center><table border=0 width=50%>
                <input name=acao value=pergunta7 type=hidden>
                       <?php
                       ...
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta7" value="<?php echo $pergunta->codresposta1?>"></td>
                           <td><?php echo $pergunta->resposta1?></td>
                       </tr>
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta7" value="<?php echo $pergunta->codresposta2?>"></td>
                           <td><?php echo $pergunta->resposta2?></td>
                       </tr>
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta7" value="<?php echo $pergunta->codresposta3?>"></td>
                           <td><?php echo $pergunta->resposta3?></td>
                       </tr>
                       
                       <tr>
                           <td colspan="2"><p align="right"><a href=javascript:salvar()><a href=pergunta8.php ><img src="../imagens/proximo.png" title="Avançar para a próxima pergunta"></a></a></p></td>
                       </tr>
                       <input name=coringa value='<?php echo $coringa ?>' type=hidden>
                       <input name=pergunta7 value='<?php echo $pergunta->codpergunta ?>' type=hidden>
                </table><center>
...
function salvar()
{
   if (pergunta7.respostapergunta7.value == ""){
      alert("Por Favor! Escolha uma opção");
      pergunta7.respostapergunta7.focus();
      exit;
   }
   document.pergunta7.submit();
}
</script>
