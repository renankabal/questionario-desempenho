<html>
	...
	<head>
		...
		<body>
			...
			<form action="../perguntas_sql.php" method="POST" name="pergunta3">
			<!-- INICIO DA TABELA DE CONTEÚDO -->
                <center><table border=0 width=50%>
                <input name=acao value=pergunta3 type=hidden>
                       <?php
                       ...
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta3" value="<?php echo $pergunta->codresposta1?>"></td>
                           <td><?php echo $pergunta->resposta1?></td>
                       </tr>
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta3" value="<?php echo $pergunta->codresposta2?>"></td>
                           <td><?php echo $pergunta->resposta2?></td>
                       </tr>
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta3" value="<?php echo $pergunta->codresposta3?>"></td>
                           <td><?php echo $pergunta->resposta3?></td>
                       </tr>
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta3" value="<?php echo $pergunta->codresposta4?>"></td>
                           <td><?php echo $pergunta->resposta4?></td>
                       </tr>
                       
                       <tr>
                           <td colspan="2"><p align="right"><a href=javascript:salvar()><a href=pergunta4.php ><img src="../imagens/proximo.png" title="Avançar para a próxima pergunta"></a></a></p></td>
                       </tr>
                       <input name=coringa value='<?php echo $coringa ?>' type=hidden>
                       <input name=pergunta3 value='<?php echo $pergunta->codpergunta ?>' type=hidden>
                </table><center>
...
function salvar()
{
   if (pergunta3.respostapergunta3.value == ""){
      alert("Por Favor! Escolha uma opção");
      pergunta3.respostapergunta3.focus();
      exit;
   }
   document.pergunta3.submit();
}
</script>
