<html>
	...
	<head>
		...
		<body>
			...
			<form action="../perguntas_sql.php" method="POST" name="pergunta5">
			<!-- INICIO DA TABELA DE CONTEÚDO -->
                <center><table border=0 width=50%>
                <input name=acao value=pergunta5 type=hidden>
                       <?php
                       ...
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta5" value="<?php echo $pergunta->codresposta1?>"></td>
                           <td><?php echo $pergunta->resposta1?></td>
                       </tr>
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta5" value="<?php echo $pergunta->codresposta2?>"></td>
                           <td><?php echo $pergunta->resposta2?></td>
                       </tr>
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta5" value="<?php echo $pergunta->codresposta3?>"></td>
                           <td><?php echo $pergunta->resposta3?></td>
                       </tr>
                       
                       <tr>
                           <td colspan="2"><p align="right"><a href=javascript:salvar()><a href=pergunta6.php ><img src="../imagens/proximo.png" title="Avançar para a próxima pergunta"></a></a></p></td>
                       </tr>
                       <input name=coringa value='<?php echo $coringa ?>' type=hidden>
                       <input name=pergunta5 value='<?php echo $pergunta->codpergunta ?>' type=hidden>
                </table><center>
...
function salvar()
{
   if (pergunta5.respostapergunta5.value == ""){
      alert("Por Favor! Escolha uma opção");
      pergunta5.respostapergunta5.focus();
      exit;
   }
   document.pergunta5.submit();
}
</script>
