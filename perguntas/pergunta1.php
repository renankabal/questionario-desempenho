<html>
	...
	<head>
		...
		<body>
			...
			<form action="../perguntas_sql.php" method="POST" name="pergunta1">
			<!-- INICIO DA TABELA DE CONTEÚDO -->
                ...
                <input name=acao value=pergunta1 type=hidden>
                       ...
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta1" value="<?php echo $pergunta->codresposta1?>"></td>
                           <td><?php echo $pergunta->resposta1?></td>
                       </tr>
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta1" value="<?php echo $pergunta->codresposta2?>"></td>
                           <td><?php echo $pergunta->resposta2?></td>
                       </tr>
                       <tr>
                           <td width="5%"><input type="radio" name="respostapergunta1" value="<?php echo $pergunta->codresposta3?>"></td>
                           <td><?php echo $pergunta->resposta3?></td>
                       </tr>
                       <tr>
                           <td colspan="2"><p align="right"><a href=javascript:salvar()><a href=pergunta2.php ><img src="../imagens/proximo.png" title="Avançar para a próxima pergunta"></a></a></a></p></td>
                       </tr>
...
function salvar()
{
   if (pergunta1.respostapergunta1.value == ""){
      alert("Por Favor! Escolha uma opção");
      pergunta1.respostapergunta1.focus();
      exit;
   }
   document.pergunta1.submit();
   location.replace('perguntas/pergunta2.php?coringa='+coringa);
